...
HAProxy and its [dataplane API](https://www.haproxy.com/documentation/dataplaneapi/latest) provide a remotely-configurable, generic load balancer for CAPICS.
...
A full list of the published HAProxy load balancer images for CAPICS may be obtained with the following command:
