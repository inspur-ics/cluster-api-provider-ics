...
export ICS_SERVER="${GOVC_URL}"
export ICS_USERNAME="${GOVC_USERNAME}"
export ICS_PASSWORD="${GOVC_PASSWORD}"
export ICS_DATACENTER="SDDC-Datacenter"
export ICS_CLUSTER="clusterapi"
export ICS_RESOURCE_POOL="clusterapi"
export ICS_DATASTORE="WorkloadDatastore"
export ICS_NETWORK="sddc-cgw-network-5"
export ICS_MACHINE_TEMPLATE="centos-7-kube-v1.16.2"
export ICS_HAPROXY_TEMPLATE="capv-haproxy-v0.5.3-77-g224e0ef6"
