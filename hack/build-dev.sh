...
CAPICS_MANAGER_IMAGE="${CAPICS_MANAGER_IMAGE:-gcr.io/cluster-api-provider-ics/dev/v1alpha3/capics-manager:latest}"
CAPICS_MANIFEST_IMAGE="${CAPICS_MANIFEST_IMAGE:-gcr.io/cluster-api-provider-ics/dev/v1alpha3/capics-manifests:latest}"
CAPI_MANAGER_IMAGE="${CAPI_MANAGER_IMAGE:-gcr.io/cluster-api-provider-ics/dev/v1alpha3/capi-manager:latest}"
CABPK_MANAGER_IMAGE="${CABPK_MANAGER_IMAGE:-gcr.io/cluster-api-provider-ics/dev/v1alpha3/cabpk-manager:latest}"
