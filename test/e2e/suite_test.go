...
import (
	...
	kindx "github.com/inspur-ics/cluster-api-provider-ics/test/e2e/kind"
)
...
func TestCAPICS(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "CAPICS e2e Suite")
}
...
var _ = BeforeSuite(func() {
	...
	By("initializing the ics session", initICSSession)
