...
import (
	...
	frameworkx "github.com/inspur-ics/cluster-api-provider-ics/test/e2e/framework"
)

var _ = Describe("CAPICS", func() {
	Describe("Cluster Creation", func() {
		...
		AfterEach(func() {
			...
			By("asserting all ICSVM resources related to this test are eventually removed")
			Eventually(func() ([]infrav1.ICSVM, error) {
				list := &infrav1.ICSVMList{}
			...
			By("asserting all ICSMachine resources related to this test are eventually removed")
			Eventually(func() ([]infrav1.ICSMachine, error) {
				list := &infrav1.ICSMachineList{}
				if err := mgmtClient.List(ctx, list, clusterLabelSelector); err != nil {
					return nil, err
				}
				return list.Items, nil
			...
			By("asserting all ICSCluster resources related to this test are eventually removed")
			Eventually(func() ([]infrav1.ICSCluster, error) {
				list := &infrav1.ICSClusterList{}
				if err := mgmtClient.List(ctx, list, clusterLabelSelector); err != nil {
					return nil, err
				}
				return list.Items, nil
