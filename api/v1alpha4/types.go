...
const (
	...
	AnnotationClusterInfrastructureReady = "ics.infrastructure.cluster.x-k8s.io/infrastructure-ready"

	// AnnotationControlPlaneReady indicates the cluster's control plane is
	// ready.
	AnnotationControlPlaneReady = "ics.infrastructure.cluster.x-k8s.io/control-plane-ready"
...
type VirtualMachineCloneSpec struct {
	...
	// without TLS certificate validation of the communication between Cluster API Provider ics
	// and the InCloud Sphere iCenter server.
	// +optional
...
// ICSMachineProviderConditionType is a valid value for ICSMachineProviderCondition.Type
type ICSMachineProviderConditionType string

// Valid conditions for an ICS machine instance
const (
	// MachineCreated indicates whether the machine has been created or not. If not,
	// it should include a reason and message for the failure.
	MachineCreated ICSMachineProviderConditionType = "MachineCreated"
)
