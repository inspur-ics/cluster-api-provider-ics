...
func (in *CPIConfig) DeepCopyInto(out *CPIConfig) {
	*out = *in
	...
	if in.ICenter != nil {
		in, out := &in.ICenter, &out.ICenter
		*out = make(map[string]CPIICenterConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CPIICenterConfig) DeepCopyInto(out *CPIICenterConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPIICenterConfig.
func (in *CPIICenterConfig) DeepCopy() *CPIICenterConfig {
	if in == nil {
		return nil
	}
	out := new(CPIICenterConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IPPoolStatus) DeepCopyInto(out *IPPoolStatus) {
	*out = *in
	if in.Allocations != nil {
		...
		*out = make(map[IPAddressStr]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
