...
// ICSVMReconciler reconciles a ICSVM object
type ICSVMReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *ICSVMReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("icsvm", req.NamespacedName)
...
func (r *ICSVMReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1alpha3.ICSVM{}).
		Complete(r)
}
