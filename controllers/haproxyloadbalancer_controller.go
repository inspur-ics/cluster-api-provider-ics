...
import (
	...
	hapi "github.com/inspur-ics/cluster-api-provider-ics/contrib/haproxy/openapi"
	"github.com/inspur-ics/cluster-api-provider-ics/pkg/context"
	"github.com/inspur-ics/cluster-api-provider-ics/pkg/haproxy"
...
func (r haproxylbReconciler) reconcileVMPre7(ctx *context.HAProxyLoadBalancerContext) (runtime.Object, error) {
	...
	mutateFn := func() (err error) {
		// Ensure the HAProxyLoadBalancer is marked as an owner of the ICSVM.
		...
		// Indicate where the ICSVM should find its bootstrap data.
		...
		// Copy the HAProxyLoadBalancer's VM clone spec into the ICSVM's
		// clone spec.
