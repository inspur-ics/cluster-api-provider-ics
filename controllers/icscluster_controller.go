...
// ICSClusterReconciler reconciles a ICSCluster object
type ICSClusterReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *ICSClusterReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("icscluster", req.NamespacedName)
...
func (r *ICSClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1alpha3.ICSCluster{}).
		Complete(r)
}
