...
func Test_GetMachinePreferredIPAddress(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			machine: &v1alpha3.ICSMachine{
				Status: v1alpha3.ICSMachineStatus{
...
func Test_GetMachineMetadata(t *testing.T) {
	testCases := []struct {
		name     string
		machine  *v1alpha3.ICSVM
		expected string
	}{
		{
			name: "dhcp4",
			machine: &v1alpha3.ICSVM{
				Spec: v1alpha3.ICSVMSpec{
					VirtualMachineCloneSpec: v1alpha3.VirtualMachineCloneSpec{
						Network: v1alpha3.NetworkSpec{
...
func TestConvertProviderIDToUUID(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			providerID:   toStringPtr("ics://12345678-1234-1234-1234-123456789abc"),
		...
		},
		{
			...
			providerID:   toStringPtr("ics://12345678-1234-1234-1234-123456789abg"),
			expectedUUID: "",
		},
	}
	for _, tc := range testCases {
...
func TestConvertUUIDtoProviderID(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedProviderID: "ics://12345678-1234-1234-1234-123456789abc",
		},
		{
			name:               "mixed case",
			uuid:               "12345678-1234-1234-1234-123456789AbC",
