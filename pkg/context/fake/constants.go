...
const (
	...
	ControllerManagerNamespace = "fake-capics-system"
	...
	// ICSClusterUUID is the UID of the fake ICSCluster resource.
	ICSClusterUUID = "10000000-0000-0000-0000-000000000000"

	// ICSMachineUUID is the UID of the fake ICSMachine resource.
	ICSMachineUUID = "10000000-0000-0000-0000-000000000001"

	// ICSVMName is the name of the fake ICSVM resource.
	ICSVMName = "fake-vm"

	// ICSVMUUID is the UID of the fake ICSVMUUID resource.
	ICSVMUUID = "20000000-0000-0000-0000-000000000002"
