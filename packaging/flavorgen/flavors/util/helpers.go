...
var (
	...
	stringVars = []string{
		...
		regexVar(env.ICSSSHAuthorizedKeysVar),
		regexVar(env.ICSDataCenterVar),
		regexVar(env.ICSDatastoreVar),
		regexVar(env.ICSNetworkVar),
		regexVar(env.ICSServerVar),
		regexVar(env.ICSTemplateVar),
		regexVar(env.ICSStoragePolicyVar),
	}
)
